      ...
      <div className="login-body">
          <div className="login-content">
              <div className="login-main">
                  ...
                  />
                  {loginNameErr && (
                      <small style={{ color: '#d3521d' }}>Please enter the Username</small>
                  )}
                  <br />
                  <p>Password</p>
                  <input
                  ...
                  />
                  {loginPasswordErr && (
                      <small style={{ color: '#d3521d' }}>Please enter the password</small>
                  )}
                  <br />
                  <button onClick={Loginvalidation}>Login</button>
                  <br />
                  <p style={{ fontSize: '15px' }}>
                      Doesn't have an account yet? <Link to={'/'}>Sign up</Link>
                  </p>
              </div>
          </div>
